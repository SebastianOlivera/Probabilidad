...
# Función para generar una muestra de la distribución binomial y crear un diagrama de cajas e histograma, generar la mediana, la moda, la media empirica y varianza empirica.
